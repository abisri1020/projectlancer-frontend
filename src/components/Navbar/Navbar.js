...
const Navbar = () => {
  ...
  return (
    <AppBar className={classes.appBar} position="static" color="inherit">
      ...
      <Link to="/" style={{textDecoration:"none", fontSize:"1.2rem", fontFamily:"sans-serif", fontWeight:"bold"}}>Home</Link>
      <Link to = "/posts" style={{textDecoration:"none", fontSize:"1.2rem", fontFamily:"sans-serif", fontWeight:"bold"}}>Projects</Link>
